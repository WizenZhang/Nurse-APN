...
#import "WZYearViewController.h"
#import "WZMonthDayViewController.h"
#define WZColor(r, g, b) ([UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1])

#define WZEdgeWidth 40
#define WZEdgeHeight 50

@interface WZSelectTimeScrollView()<YearViewControllerDelegate, MonthAndDayControllerDelegate>

/** 控制器宽度 */
@property (nonatomic, assign) CGFloat nextWidth;

/** selectController */
@property (nonatomic, assign) WZYearViewController *yearController;

/** selectController */
@property (nonatomic, assign) WZMonthDayViewController *monthAndDayController;


@end


@implementation WZSelectTimeScrollView
...
-(void) setUpYearWithSuperController:(UIViewController *)superController{
    ...
    WZYearViewController *year = [[WZYearViewController alloc] init];
    ...
    year.selectColor = WZColor(60, 45, 140);
...
-(void) setUpMonthAndDayWithSuperController:(UIViewController *)superController{
    ...
    WZMonthDayViewController *monthAndDay = [[WZMonthDayViewController alloc] initWithFrame:selectRect];
    ...
    self.nextWidth += selectWidth;
    monthAndDay.selectColor = WZColor(60, 45, 140);
...
-(void)reloadInputViews
{
    ...
    [self.monthAndDayController.collectionView reloadData];
