...
#define WZBasicFontToHeight 0.83
#define WZSelectAlpha 0.6

@interface WZShowTimeView()
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.headerBackgroundColor = WZColor(60, 45, 140);
        self.headerColor = [UIColor whiteColor];
        
        self.contentBackgroundColor = WZColor(71, 55, 169);
...
-(void) generateHeaderView:(CGRect)rect{
    ...
    self.titleLabel.font = [UIFont boldSystemFontOfSize:rect.size.height * WZBasicFontToHeight-4];
...
-(void)setMonthAndDay:(CGRect)rect{
    ...
    self.animMonthLabel.font = [UIFont systemFontOfSize:smallestUnitHeight * WZBasicFontToHeight];
...
-(void)monthAndDayTap{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        _animYearLabel.alpha = WZSelectAlpha;
...
-(void)setYear:(CGRect)rect{
    ...
    //初始化透明度
    self.animYearLabel.alpha = WZSelectAlpha;
    
    self.animYearLabel.text = self.yearText;
    self.animYearLabel.textColor = self.contentColor;
    self.animYearLabel.font = [UIFont systemFontOfSize:smallestUnitHeight * WZBasicFontToHeight];
...
-(void)yearTap{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        // set select color
        _animMonthLabel.alpha = WZSelectAlpha;
        _animDayLabel.alpha = WZSelectAlpha;
